package com.babu.practice.udemy.design_patterns.behavioral.strategy;
...
class QuadraticEquationSolver
{
  ...
  public Pair<Complex, Complex> solve(double a, double b, double c)
  {
	  ...
	  Complex discsqrt = Complex.sqrt(discriminant);
	  Complex divider = new Complex(2*a, 0);
	  return new Pair<Complex, Complex>(new Complex(-b, 0).plus(discsqrt).divides(divider),
			  new Complex(-b, 0).minus(discsqrt).divides(divider));
  }
}
...
public class Demo {
	...
	public static void main(String[] args) {
		//QuadraticEquationSolver solver = new QuadraticEquationSolver(new RealDiscriminantStrategy());
		QuadraticEquationSolver solver = new QuadraticEquationSolver(new OrdinaryDiscriminantStrategy());
		Pair<Complex, Complex> solution = solver.solve(2.0,  5.0, 2.0);
		System.out.println(solution.first.toString());
		System.out.println(solution.second.toString());
	}
}
