...
public class FirstPositiveMissingNumber {
	...
	public static int firstMissingPositive(ArrayList<Integer> a) {
		...
		for (int k = 0; k <= j; k++) {
			int idx = Math.abs(a.get(k));
			if (idx <= j + 1) {
				a.set(idx - 1, -a.get(idx-1));
			}
		}
